...
@Service
public class RecentlyReadFeedsSortAndFilterService {
    ...
    private List<FeedItemUser> findFilteredAndOrderedFeedItemsUser(User user, LocalDate startDate, String order,
        ...
        switch (order) {
            case ORDER_BY_LATEST: {
                ...
                if (startDate == null)
                    page = recentlyReadFeedItemUserRepository
                            .findByUserAndLastReadingDateNotNullOrderByLastReadingDateDesc(user, pageable);
                else
                    page = recentlyReadFeedItemUserRepository
                            .findByUserAndLastReadingDateNotNullAndFeedItem_publishLocalDateGreaterThanEqualOrderByLastReadingDateDesc(
            ...
            case ORDER_BY_OLDEST: {
                ...
                if (startDate == null)
                    page = recentlyReadFeedItemUserRepository
                            .findByUserAndLastReadingDateNotNullOrderByLastReadingDateAsc(user, pageable);
                else
                    page = recentlyReadFeedItemUserRepository
                            .findByUserAndLastReadingDateNotNullAndFeedItem_publishLocalDateGreaterThanEqualOrderByLastReadingDateAsc(
                                    user, startDate, pageable);
            ...
            case ORDER_BY_CHANNEL: {
                ...
                if (startDate == null)
                    page = recentlyReadFeedItemUserRepository
                            .findByUserAndLastReadingDateNotNullOrderByFeedItem_Channel_TitleAscLastReadingDateDesc(
                                    user, pageable);
                else
                    page = recentlyReadFeedItemUserRepository
                            .findByUserAndLastReadingDateNotNullAndFeedItem_publishLocalDateGreaterThanEqualOrderByFeedItem_Channel_TitleAscLastReadingDateDesc(
                                    user, startDate, pageable);
    ...
    private List<FeedItemUser> findFeedItemUsersOrderedByCategoryNameAndPublishLocalDate(User user,
        ...
        if (startDate == null)
            channelsUser.forEach(cu -> feedItemsUser.addAll(recentlyReadFeedItemUserRepository
                    .findByUserAndLastReadingDateNotNullAndFeedItem_Channel(user, cu.getChannel())));
        else
            channelsUser.forEach(cu -> feedItemsUser.addAll(recentlyReadFeedItemUserRepository
                    .findByUserAndLastReadingDateNotNullAndFeedItem_ChannelAndFeedItem_publishLocalDateGreaterThanEqual(
