...
public class Constants {
    ...
    public final static String CONFIRMATION_MESSAGE = "To confirm your account by Feedify, please click here: " + Endpoints.HOST_NAME + "confirm-account?confirmationToken=";
    public final static String RESET_PASSWORD_MESSAGE = "To reset your password on Feedify, please click here: " + Endpoints.HOST_NAME + "new-password?token=";
